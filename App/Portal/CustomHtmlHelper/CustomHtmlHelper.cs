...
namespace Portal.CustomHtmlHelper
{
    public static class CustomHtmlHelper
    {
        ...
        public static MvcHtmlString Breadcrumb(this HtmlHelper helper, string controllerName, string actionName)
        {
            ...
            if (controller != null)
            {
                string menuName = PorDB.PTMenu.Where(o => o.MUID == controller.MAP_MUID).First().MU_NM;
                BreadcrumbModel b = new BreadcrumbModel();
                b.menuName = menuName;
                b.menuPath = "#";
                breadcrumb.Add(b);
            }
            ...
            if (action != null)
            {
                string menuName = PorDB.PTMenu.Where(o => o.MUID == action.MAP_MUID).First().MU_NM;
                BreadcrumbModel b = new BreadcrumbModel();
                b.menuName = menuName;
                b.menuPath = "#" ;
                breadcrumb.Add(b);
